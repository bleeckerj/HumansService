...
public class TwitterService {
    ...
    public static TwitterService createTwitterServiceOnBehalfOfUsername(
            String aUsername) throws BadAccessTokenException {
    ...
    public List<TwitterStatus> serviceRequestStatusForUserID(String aUserID) {
        ...
        if (most_recent == null) {
            ...
            result = serviceRequestStatusForUserIDAndSinceID(aUserID,
                    most_recent.getIdStr());
            result.addAll(statusDAO.findByExactUserID(aUserID));
        }
        return result;
    }
    ...
    */
    List<com.nearfuturelaboratory.humans.twitter.entities.generated.TwitterStatus> saveStatusJson(JSONArray status) {
        List<com.nearfuturelaboratory.humans.twitter.entities.generated.TwitterStatus> result = new ArrayList<com.nearfuturelaboratory.humans.twitter.entities.generated.TwitterStatus>();
    ...
    public boolean localServiceStatusIsFreshFor(String aUserID) {
        boolean result = false;
        com.nearfuturelaboratory.humans.twitter.entities.generated.TwitterStatus most_recent = this
