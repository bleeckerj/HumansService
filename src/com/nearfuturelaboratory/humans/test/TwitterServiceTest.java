...
public class TwitterServiceTest {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		try {
			...
			logger.debug("Hey Ho!");
			twitter = TwitterService.createTwitterServiceOnBehalfOfUsername("fabiengirardin");
	...
	public void test_getLargeImageURL() {
		List<TwitterFollows>follows = twitter.getFriends();
		for(TwitterFollows friend : follows) {
	...
	public void test_getFollows() {
		logger.debug(twitter.getFriends());
	}
	
	@Test
	public void test_localFollowsIsFresh() {
		twitter.localFollowsIsFresh();
	}
